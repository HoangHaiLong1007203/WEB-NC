...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        ...
        A place to exist. Whether you go for business or pleasure,
        <br>
        HL Hotel brings you a comfortable and convenient stay.
        </p>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="container-fluid flex-lg-column align-items-stretch">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <label for="form-lable">Check-in</label>
                                <input type="date" class="form-control shadow-none mb-3 mt-2">
                                <label for="form-lable">Check-out</label>
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <div class="mb-2">
                                    ...
                                    <label for="form-check-lable" for="f1">Facilities one</label>
                                </div>
                                <div class="mb-2">
                                    <input type="checkbox" id="f1" class="form-check-input shadow-none me-1">
                                    <label for="form-check-lable" for="f2">Facilities two</label>
                                </div>
                                <div class="mb-2">
                                    <input type="checkbox" id="f1" class="form-check-input shadow-none me-1">
                                    <label for="form-check-lable" for="f3">Facilities three</label>
                                </div>
                            </div>
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <div class="d-flex">
                                    <div class="me-3">
                                        <label for="form-lable">Adults</label>
                                        <input type="number" class="form-control shadow-none mt-2">
                                    </div>
                                    <div>
                                        <label for="form-lable">Childrens</label>
                                        <input type="number" class="form-control shadow-none mt-2">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-9 cpl-md-12 px-4">
                <?php
