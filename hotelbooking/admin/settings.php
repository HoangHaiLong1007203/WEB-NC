...
<body class="bg-light">
    ...
    <div class="col-lg-2 bg-dark border-top border-3 border-secondary" id="dashboard-menu" style="position: fixed;  z-index: 10;">
            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-1 fw-bold">Introduce</h6>
                        ...
                        <form id="general_s_form">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class= "mb-3">
                                        <label for="form-label fw-bold">Page title</label>
                                        <input type="text" name="site_title" id="site_title_inp" class="form-control shadow-none" required>
                                    </div>
                                    <div class= "mb-3">
                                        <label for="form-label fw-bold">Introduce</label>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="card-title m-0">Turn off a website</h5>
                        ...
                        <p class="card-text">
                        Reservations cannot be made without the website opened
                        </p>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="card-title m-0">Connection settings</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    <h6 class="card-subtitle mb-1 fw-bold">Connect</h6>
                                    <p class="card-text mb-1">
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid p-0">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class= "mb-3">
                                                    <label for="form-label fw-bold">Địa chỉ</label>
                                                    <input type="text" name="address" id="address_inp" class="form-control shadow-none" required>
                                                </div>
                                                <div class= "mb-3">
                                                    <label for="form-label fw-bold">Google Map Link</label>
                                                    <input type="text" name="gmap" id="gmap_inp" class="form-control shadow-none" required>
                                                </div>
                                                <div class= "mb-3">
                                                    <label for="form-label fw-bold">Phone Number (with country code)</label>
                                                ...
                                                <div class= "mb-3">
                                                    <label for="form-label fw-bold">Email</label>
                                                    <input type="email" name="email" id="email_inp" class="form-control shadow-none" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class= "mb-3">
                                                    <label for="form-label fw-bold">Links </label>
                                                    <div class="input-group mb-3">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" name="tt" id="tt_inp" class="form-control shadow-none">
                                                    </div>
                                                </div>
                                                <div class= "mb-3">
                                                    <label for="form-label fw-bold">iFrame Src</label>
                        ...
                        <div class="row" id="team-data">
                            <div class="col-md-2 mb-3">
                                <div class="card bg-dark text-white">
                                    <img src="../images/about/3.jpg" class="card-img">
